...
- Compare debt structure across countries for a specific date
- Visualize the relationship between **debt-to-GDP ratio** and **foreign investor share** (IRI index)

All data used comes from the **IMF Investor Base Sovereign Debt Database** (1989Q4 – 2024Q2), compiled by the **IMF Monetary and Capital Markets Department**.
